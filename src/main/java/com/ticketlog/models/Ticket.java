...
@Entity
@Table(name="allticket")
public class Ticket {
	

	@Id
	@Column(name="id", unique=true, nullable=false)
	@SequenceGenerator(name="generator_ticketId", sequenceName="ticket.generator_ticketId")
	@GeneratedValue(strategy=SEQUENCE, generator="generator_ticketId")
	/*@GeneratedValue(strategy=GenerationType.AUTO)*/
	private Integer ticketId;
	
	@Column(name="subticketId")
	...
	@Column(name="subTicketFlag")
	private String subTicketFlag;
	...
	public String getSubTicketFlag() {
		return subTicketFlag;
	}
	public void setSubTicketFlag(String subTicketFlag) {
		this.subTicketFlag = subTicketFlag;
	}
